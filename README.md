...
### DevOps Engineer | CI/CD Pipeline Architect | Cloud Infrastructure
...
I build **CI/CD pipelines** and automate cloud infrastructure. Currently diving deep into the DevOps ecosystem — from container orchestration to infrastructure as code.

-  Building scalable CI/CD pipelines with Jenkins & GitHub Actions
-  Learning **Kubernetes, Terraform, Ansible, and cloud-native tools**
-  Ask me about **Linux, Docker, AWS, CI/CD, Git, Bash**
-  Fun fact: I run **Arch Linux** (btw) and maintain my own dotfiles
